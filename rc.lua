...
-- My favorites menu
myfavoritesmenu = {
   { "nsnake",         terminal .. " -e nsnake" },
   { "pacman4console", terminal .. " -e pacman4console" }
}
